...
export default function NewFollowUpPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch("http://localhost:8002/api/v1/registry/followups/", {
        method: "POST",
  ...
  return (
    <main style={{ padding: "40px", maxWidth: "680px" }}>
      ...
      <h1 style={{ fontSize: "24px", margin: "8px 0 4px" }}>Add Follow-up</h1>
      {ccase && (
      ...
      <form onSubmit={handleSubmit} style={{ background: "white", padding: "24px", borderRadius: "12px" }}>
        ...
        <section style={section}>
          ...
          <div style={row}>
            ...
            <div style={col}>
              ...
              <input style={input} name="attending_physician" value={form.attending_physician} onChange={handleChange} placeholder="e.g. Dr. Santos" />
            </div>
          </div>
        </section>
        ...
        <section style={section}>
          ...
          <div style={row}>
            <div style={col}>
              ...
              <input style={input} type="number" step="0.01" name="weight_kg" value={form.weight_kg} onChange={handleChange} placeholder="e.g. 58.5" />
            </div>
            <div style={col}>
        ...
        <section style={section}>
          ...
          <div style={{ marginBottom: "16px" }}>
            ...
            <input
              ...
              placeholder="e.g. Complete remission, Stable disease"
            />
          </div>
          <div style={{ marginBottom: "16px" }}>
        ...
        <button
          ...
          style={{
            width: "100%",
            padding: "12px",
            background: loading ? "#b2bec3" : "#00b894",
            color: "white",
            border: "none",
            borderRadius: "8px",
            fontSize: "15px",
